...
public class PayResult extends _ApiResultBase implements Serializable {
    ...
    private String transaction_id;//交易ID，用于退款
    ...
    @Override
    public PayResult loadFromResponse(Map<String, String> response) {
        ...
        this.sign_type = jmap.get("sign_type");
        ...
        this.cash_fee = jmap.getInteger("cash_fee");
    ...
    public String toString() {
        return new ToStringBuilder(this)
                ...
                .append("is_subscribe", is_subscribe)
                .append("trade_type", trade_type)
                .append("bank_type", bank_type)
                .append("total_fee", total_fee)
                .append("settlement_total_fee", settlement_total_fee)
                .append("fee_type", fee_type)
                .append("cash_fee", cash_fee)
                .append("cash_fee_type", cash_fee_type)
                .append("coupon_fee", coupon_fee)
                .append("coupon_count", coupon_count)
